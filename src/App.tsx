...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#04060a] font-sans text-slate-200 flex flex-col antialiased selection:bg-emerald-500 selection:text-white">
      <CustomCursor />
      
      {/* 1. Upper Enterprise Navigation Bar */}
      <header className="bg-[#04060a]/90 backdrop-blur-xl border-b border-white/[0.06] sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="relative w-10 h-10 flex items-center justify-center shrink-0">
              <svg className="w-9 h-9 animate-pixis-spin" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="35" cy="50" r="22" stroke="url(#logoGrad1)" strokeWidth="12" strokeLinecap="round" opacity="0.85" />
                <circle cx="65" cy="50" r="22" stroke="url(#logoGrad2)" strokeWidth="12" strokeLinecap="round" opacity="0.85" />
                <defs>
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-extrabold text-white tracking-tight font-display text-lg">
                  GEO<span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Engine</span>
                </span>
              </div>
          ...
          <div className="flex items-center gap-4">
            <a
              href="#live-sandbox"
              className="hidden sm:inline-flex bg-gradient-to-r from-emerald-500 via-cyan-500 to-purple-600 hover:opacity-95 text-white font-mono text-[10px] font-bold py-3 px-5 rounded-xl shadow-lg shadow-cyan-500/10 transition-all uppercase tracking-widest cursor-pointer"
      ...
      <section className="relative overflow-hidden bg-[#04060a] pt-32 pb-24 border-b border-white/[0.06]">
        
        {/* Futuristic Grid & Ambient Glows */}
        <div className="absolute inset-0 pixis-grid-lines opacity-30"></div>
        <div className="absolute inset-0 pixis-grid-dots opacity-20"></div>
        
        {/* Floating Pixis Glowing Orbs */}
        <div className="absolute right-0 top-1/4 w-[450px] h-[450px] bg-gradient-to-tr from-cyan-500/10 to-emerald-500/5 rounded-full blur-[120px] pointer-events-none -mr-32 animate-pixis-pulse"></div>
        <div className="absolute left-10 bottom-1/4 w-[350px] h-[350px] bg-gradient-to-tr from-purple-500/10 to-pink-500/5 rounded-full blur-[120px] pointer-events-none -ml-16 animate-pixis-pulse" style={{ animationDelay: "2s" }}></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl text-left">
            ...
            <ScrollReveal direction="down" delay={0.1}>
              <div 
                className="inline-flex items-center gap-2 bg-white/[0.03] border border-white/[0.08] px-4 py-2 rounded-full mb-8 backdrop-blur-md cursor-help"
            ...
            <ScrollReveal direction="up" delay={0.2}>
              <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-[1.05] mb-8">
                Command Your Brand Presence Across <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-400 via-purple-400 to-pink-500 font-extrabold">Generative Engines</span>.
              </h1>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" delay={0.4}>
              <form 
                ...
                className="max-w-xl bg-white/[0.03] border border-white/[0.08] focus-within:border-cyan-500/40 rounded-2xl p-2 flex items-center gap-2 mb-16 shadow-2xl relative backdrop-blur-xl transition-all duration-300"
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-gradient-to-r from-emerald-500 via-cyan-500 to-purple-600 hover:opacity-95 text-white font-mono text-[10px] font-bold py-3.5 px-6 rounded-xl shrink-0 uppercase tracking-widest flex items-center gap-2 shadow-lg shadow-cyan-500/10 cursor-pointer transition-all duration-300"
          ...
          <ScrollReveal direction="up" delay={0.5}>
            <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-6 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6 relative backdrop-blur-xl">
              <div 
                className="flex items-center gap-4 shrink-0 border-b md:border-b-0 md:border-r border-white/[0.06] pb-4 md:pb-0 md:pr-8 cursor-help"
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 shrink-0">
      ...
      <ScrollReveal direction="up" delay={0.1}>
        <section className="bg-[#04060a] text-white py-24 border-t border-white/[0.06] relative overflow-hidden">
          <div className="absolute inset-0 pixis-grid-lines opacity-20"></div>
          <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-[#04060a] to-transparent pointer-events-none"></div>
          
          {/* Ambient Gradient behind CTA */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] bg-gradient-to-r from-emerald-500/10 via-cyan-500/15 to-purple-500/10 rounded-full blur-[100px] pointer-events-none animate-pixis-pulse"></div>

          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center">
            
            <span className="text-[10px] font-mono text-emerald-400 uppercase tracking-[0.25em] font-bold bg-white/[0.02] border border-white/[0.08] px-4 py-2 rounded-full backdrop-blur-md">
            ...
            <a
              href="#live-sandbox"
              className="mt-10 bg-gradient-to-r from-emerald-500 via-cyan-500 to-purple-600 hover:opacity-95 text-white font-mono text-xs font-bold py-4 px-8 rounded-xl transition-all shadow-lg shadow-cyan-500/20 flex items-center gap-2 group uppercase tracking-widest cursor-pointer animate-pulse"
      ...
      <footer className="bg-[#020408] text-slate-400 py-16 border-t border-white/[0.06] text-[11px] font-mono relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start border-b border-white/[0.06] pb-12">
              ...
              <div className="flex items-center gap-3">
                <div className="relative w-8 h-8 flex items-center justify-center shrink-0">
                  <svg className="w-7 h-7 animate-pixis-spin" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="35" cy="50" r="22" stroke="url(#footerLogoGrad1)" strokeWidth="12" strokeLinecap="round" opacity="0.85" />
                    <circle cx="65" cy="50" r="22" stroke="url(#footerLogoGrad2)" strokeWidth="12" strokeLinecap="round" opacity="0.85" />
                    <defs>
                ...
                <span className="font-extrabold text-white tracking-tight text-base font-display">GEO<span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">Engine</span></span>
              </div>
          ...
          <div className="pt-10 flex flex-col sm:flex-row items-center justify-between gap-4 text-slate-500">
            ...
            <div className="text-[10px] text-slate-500">
              Pipeline Ref: GEO-CORE-V2.4.0 • Models Active: gemini-2.0-flash
            </div>
          </div>
