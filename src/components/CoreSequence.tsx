...
export default function CoreSequence() {
  return (
    <section className="py-24 bg-[#04060a] border-y border-white/[0.06] relative overflow-hidden" id="core-pipeline">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            return (
              ...
              >
                ...
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-12 left-[85%] right-[-15%] h-[1px] bg-gradient-to-r from-cyan-500/20 to-transparent z-0">
                    <div className="absolute right-0 top-1/2 -translate-y-1/2 text-cyan-400/50">
                ...
                {/* Card Block */}
                <div 
                  className="bg-white/[0.02] border border-white/[0.06] hover:border-emerald-500/40 hover:bg-white/[0.04] rounded-2xl p-6 relative z-10 shadow-2xl transition-all duration-300 flex flex-col h-full group backdrop-blur-xl cursor-crosshair"
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-5">
                    <div className="w-12 h-12 rounded-xl bg-white/[0.02] border border-white/[0.08] flex items-center justify-center text-slate-300 group-hover:bg-gradient-to-tr group-hover:from-emerald-500/10 group-hover:to-cyan-500/10 group-hover:border-emerald-500/30 group-hover:text-emerald-400 transition-colors duration-300">
                  ...
                  {/* Title */}
                  <h3 className="text-sm font-bold text-white tracking-tight mb-3 group-hover:text-emerald-400 transition-colors font-display">
                    {step.title}
                  </h3>
        ...
        <ScrollReveal direction="up" delay={0.5}>
          <div 
            className="mt-14 bg-white/[0.01] rounded-2xl border border-white/[0.06] p-5 flex flex-col sm:flex-row items-center justify-between gap-4 backdrop-blur-md cursor-help"
          ...
          >
            ...
            <span className="text-[10px] font-bold font-mono text-emerald-400 bg-emerald-400/10 px-3 py-1.5 rounded-lg border border-emerald-400/20 uppercase tracking-wider flex items-center gap-2">
