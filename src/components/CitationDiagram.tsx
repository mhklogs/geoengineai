...
export default function CitationDiagram() {
  return (
    <ScrollReveal direction="up" delay={0.2}>
      <div 
        className="bg-white/[0.01] border border-white/[0.06] backdrop-blur-xl rounded-2xl p-6 shadow-2xl relative overflow-hidden cursor-crosshair"
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative z-10">
          {/* Step 1 */}
          <div 
            className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4 flex flex-col items-center text-center shadow-md backdrop-blur-lg"
          ...
          >
            <div className="w-10 h-10 rounded-full bg-white/[0.02] flex items-center justify-center text-slate-300 font-mono text-xs font-bold mb-3 border border-white/[0.08]">
              01
            </div>
          ...
          {/* Connection Arrow 1 */}
          <div className="hidden md:flex absolute top-1/2 left-[30%] -translate-y-1/2 z-0 text-cyan-400/50">
          ...
          >
            <div className="w-10 h-10 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-400 font-mono text-xs font-bold mb-3 border border-cyan-500/20">
              02
            </div>
          ...
          {/* Connection Arrow 2 */}
          <div className="hidden md:flex absolute top-1/2 left-[64%] -translate-y-1/2 z-0 text-cyan-400/50">
            <ArrowRight className="w-5 h-5 animate-pulse" />
          </div>

          {/* Step 3 */}
          <div 
            className="bg-white/[0.02] border border-emerald-500/30 rounded-xl p-4 flex flex-col items-center text-center shadow-md backdrop-blur-lg ring-1 ring-emerald-500/10"
          ...
          >
            <div className="w-10 h-10 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-400 font-mono text-xs font-bold mb-3 border border-emerald-500/20">
              03
            </div>
        ...
        <div className="mt-6 pt-4 border-t border-white/[0.06] grid grid-cols-1 sm:grid-cols-2 gap-4 text-[11px] text-slate-400 relative z-10">
          <div className="flex items-start gap-2">
            <Database className="w-4 h-4 text-emerald-500/70 shrink-0 mt-0.5" />
          ...
          <div className="flex items-start gap-2">
            <Bot className="w-4 h-4 text-cyan-500/70 shrink-0 mt-0.5" />
